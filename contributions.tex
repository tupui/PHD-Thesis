...
\begin{enumerate}
\item[\textbf{7}] accepted and published articles, % TODO update before sending
...
This online course has been run twice, and I have been presenting the live sessions. We have received a lot of good feedback and are improving and updating this product continuously.
...
\centering
\subfloat[]{
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{fig/contributions/doe/kde_2_C.pdf}}
 ~       
\subfloat[]{
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{fig/contributions/doe/kde_10_C.pdf}}

\subfloat[]{
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{fig/contributions/doe/kde_20_C.pdf}}
 ~       
\subfloat[]{
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{fig/contributions/doe/kde_30_C.pdf}}
\caption{Adimonsionalized $C^2$-discrepancy function of the number of dimensions $d$ of the parameter space and of the size $N_s$ of the design for various DoE methods.}
\label{fig:conv-dim-ns}
\end{figure}
\begin{figure}[!h]               
\centering
\subfloat[]{
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{fig/contributions/doe/kde_err_2_C.pdf}}
 ~       
\subfloat[]{
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{fig/contributions/doe/kde_err_10_C.pdf}}

\subfloat[]{
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{fig/contributions/doe/kde_err_20_C.pdf}}
 ~       
\subfloat[]{
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{fig/contributions/doe/kde_err_30_C.pdf}}
\caption{Adimonsionalized $2\sigma$ deviation on the $C^2$-discrepancy function of the number of dimensions $d$ of the parameter space and of the size $N_s$ of the design for various DoE methods.}
...
\caption{Example of a 2-dimensional subprojection of the sample of size $N_s=50$ in dimension $d=30$.}
...
\section{Conclusion}\label{sec:visu_ccl}
