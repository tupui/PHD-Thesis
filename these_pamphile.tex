...
\title{Uncertainty Quantification in High Dimensional Problem \\ Quantification des incertitudes pour des problèmes de dimensions élevées} 
\author{Pamphile Tupui ROY}
\defencedate{soon}%1 Avril 2019}
...
\makesomeone{judge}{3}{Mme Clémentine Prieur}{Professeur d'Université, Université de Grenoble Alpes}{Examinateur}
