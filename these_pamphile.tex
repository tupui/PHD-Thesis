...
\title{Uncertainty Quantification in Large Eddy Simulations.} 
...
%% Referee
\nreferee{2}
\makesomeone{referee}{1}{Premier RAPPORTEUR}{Totoland}{Toto1}
\makesomeone{referee}{2}{Second RAPPORTEUR}{Totoland}{Toto2}
%% Jury
\njudge{7}
\makesomeone{judge}{1}{Premier MEMBRE}{Professeur d'Université, Toulouse}{Rapporteur}
